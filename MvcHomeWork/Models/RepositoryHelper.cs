namespace MvcHomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static V_客戶資料清單Repository GetV_客戶資料清單Repository()
		{
			var repository = new V_客戶資料清單Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static V_客戶資料清單Repository GetV_客戶資料清單Repository(IUnitOfWork unitOfWork)
		{
			var repository = new V_客戶資料清單Repository();
